...
/**
 * DESC : Joda Time 을 사용하여 날짜, 시간 및 요일 계산, 유효성 체크와 포맷 변경 등의 기능을 제공한다.<br>
 * <br>
 *
 ...
 */
public final class UtCoDateUtils {

    private UtCoDateUtils() {
    }
    ...
    /**
     * 현재 날짜, 시간을 조회을 조회하고, pattern 형태의 포맷으로 문자열을 반환한다.<br>
     * <br>
     *
    ...
    /**
     * 입력받은 일자의 요일을 반환한다.<br>
     * Locale 정보를 받아 해당하는 언어에 대해서 약어로 보여주거나 전체 요일 형태로 보여준다.<br>
     * <br>
     *
    ...
    /**
     * 입력받은 두 날짜 사이의 일자를 계산한다.<br>
     * -startDate와 endDate는 patter의 포맷형식을 꼭 따라야 한다.<br>
     * <br>
     *
    ...
    public static int getDays(String startDate, String endDate, String pattern) {
        ...
        int result = (int) (startMillis / (MINUTES_60 * SECONDS_60 * MILLI_SECONDS_1000 * HOURS_24));
        int result1 = (int) (endMillis / (MINUTES_60 * SECONDS_60 * MILLI_SECONDS_1000 * HOURS_24));

        return result1 - result;
    }

    /**
     * 입력받은 두 일자가 같은지 여부를 확인한다.<br>
     * <br>
     *
     ...
     * 마이너스 일자는 입력받은 일자보다 이전의 일자로 계산해서 반환한다.<br>
     * <br>
     *
     ...
     * 마이너스 개월수는 입력받은 일자보다 이전 일자로 계산해서 반환한다.<br>
     * <br>
     *
     ...
     * 마이너스 년수는 입력받은 일자보다 이전 일자로 계산해서 반환한다.<br>
     * <br>
     *
    ...
    /**
     * 입력된 일자에 대해서 년,월,일만큼 가감해서 계산한 일자를 반환한다.<br>
     * <br>
     *
    ...
    /**
     * 문자열을 java.util.Date 타입으로 변경한다.<br>
     * <br>
     *
    ...
    /**
     * java.util.Date 타입을 문자열로 변경한다.<br>
     * <br>
     *
    ...
    /**
     * java.util.Date 타입을 패턴에 맞는 문자열로 변경한다.<br>
     * <br>
     *
    ...
    /**
     * 문자열을 java.sql.Date 타입으로 변환한다.<br>
     * <br>
     *
    ...
    /**
     * 문자열을 java.sql.Timestamp 타입으로 변환한다.<br>
     * <br>
     *
    ...
    /**
     * 패턴에 맞게 들어온 문자열을 java.sql.Timestamp 타입으로 변환한다.<br>
     * <br>
     *
    ...
    /**
     * java.sql.Timestamp 타입의 일자를 문자열로 변환한다.<br>
     * <br>
     *
    ...
    /**
     * java.sql.Timestamp 타입의 일자를 패턴에 맞는 문자열로 변환한다.<br>
     * <br>
     *
    ...
    /**
     * 문자열을 java.util.Calendar 타입으로 변환한다.<br>
     * <br>
     *
    ...
    public static Calendar convertStringToCalender(String str) {
        ...
        String second = str.substring(12, INT_14);

        return (new GregorianCalendar(UtCoStringUtils.string2integer(year), UtCoStringUtils.string2integer(month) - 1,
                UtCoStringUtils.string2integer(day), UtCoStringUtils.string2integer(hour),
                UtCoStringUtils.string2integer(minute), UtCoStringUtils.string2integer(second)));
    }

    /**
     * java.util.Calendar타입의 일자를 문자열로 변환한다.<br>
     * <br>
     *
    ...
    /**
     * 사용자 정의 패턴에 맞게 들어온 문자열을 새로운 문자열로 변환한다.<br>
     * <br>
     *
    ...
    /**
     * 입력된 두 일자 사이의 분을 계산하여 반환한다.<br>
     * <br>
     *
     * DateUtils.getMinutes(new GregorianCalendar(2010, 11, 14, 12, 34, 12), new GregorianCalendar(2010, 11, 14, 13, 32,
     * 12)) = 58
     *
    ...
    /**
     * 현재 일자를 yyyy-MM-dd 패턴의 문자열로 반환한다.<br>
     * <br>
     *
    ...
    public static boolean isLeapYear(int year) {
        return ((year % 4 == 0 && year % 100 != 0) || year % INT_400 == 0) ? true : false;
    }
