...
/**
 * DESC : 문자열 관련 검색, 변환, 치환, 유효성 체크 등의 기능을 제공한다.<br>
 * <br>
 *
 ...
 * @Company think-tree
 * @author ks-lee
 * @Date 2012. 10. 31. 오후 8:27:34
 */
public final class UtCoStringUtils {

    private UtCoStringUtils() {
    }
     ...
     * @return 두 단어가 같을 경우 0 단어1이 단어2보다 작을 경우 0 미만 단어1이 단어2보다 클 경우 0 초과
    ...
    /**
     * 두단어를 대소 문자 무시하고 사전 편찬 순서대로 비교한다.<br>
     * <br>
     *
     ...
     * @return 검색문자가 포함되어있는 경우 true , 포함되어있지 않거나 입력 문자열이 <code>null</code>인경우 false
     */
    ...
    /**
     * 입력된 문자열이 주어진 character들을 포함하는지 체크<br>
     * <br>
     *
    ...
    /**
     * 입력된 문자열에 대해서 같은 character가 동일하게 반복하는지 체크<br>
     * <br>
     *
    ...
    /**
     * 입력된 underscore 형태의 문자열을 camel case 형태로 변환<br>
     * <br>
     *
    ...
    /**
     * 주어진 char의 형태에 맞게 잘라진 문자열을 camel case 형태로 변환<br>
     * <br>
     *
    ...
    /**
     * camel case 형태의 문자열을 underscore 형태의 문자열로 변환<br>
     * <br>
     *
    ...
    /**
     * 첫번째 문자열과 두번째 문자열을 비교해서 같으면 세번째 문자열을 다르면 네번재 문자열을 반환한다.<br>
     * <br>
     *
    ...
    /**
     * 한 String 객체 안에서 특정 패턴 안에 포함된 모든 character들을 제거한다.<br>
     * <br>
     *
     * StringUtils.deleteChars("zzAccBxx", "AB") = "zzccxx"
     *
     * @param str the source String to search
     * @param chars the char to search for and remove
     ...
     * 겹치지 않는 형태로 계산한다. + 따라서, 제거된 후에도 old 패턴은 남아 있을 수 있다.<br>
     * <br>
     *
     ...
     *
     * @param str the source String to search
     * @param pattern the String to search for and remove
     ...
     * delimiter가 null일 경우, 주어진 String을 하나의 element로 가지는 String[]를 return한다.<br>
     * <br>
     *
     * StringUtils.delimitedStringToStringArray("aaa.bbb.ccc.ddd", "."); = test[0]="aaa", test[1]="bbb"...
     *
     * @param str the silgle String to convert
     * @param delimiter delimiter for conversioin
     ...
     * @param str 문자열
     * @param suffix 검색문자
     * @return 문자열이 검색문자로 끝나는경우와 문자열 양쪽모두 <code>null</code>인경우 <code>true</code>
     */
     ...
     * @return 문자열이 배열안의 검색문자로 끝나는경우와 문자열 양쪽모두 <code>null</code>인경우 <code>true</code>
     *
     */
     ...
     * @param str 문자열
     * @param suffix 검색문자
     * @return 문자열이 검색문자로 대소문자 구분없이 끝나는경우와 문자열 양쪽모두 <code>null</code>인경우 <code>true</code>
     */
    ...
    /**
     * 해당하는 문자열에 대해서 byte 단위에 대해서 길이 계산해서 총 길이 반환<br>
     * <br>
     *
    ...
    /**
     * 주어진 문자열에 대해서 해당하는 문자열이 포함되어 있는 숫자 반환<br>
     * <br>
     *
    ...
    /**
     * 대소문자 구분없이 주어진 문자열에 대해서 해당하는 문자열이 포함되어 있는 갯수를 반환<br>
     * <br>
     *
     ...
     * @see org.springframework.util.StringUtils#countOccurrencesOf(String, String)
     */
    ...
    /**
     * 입력된 문자열을 주어진 token에 대해서 분리 후 arraylist 형태로 반환<br>
     * <br>
     *
    ...
    /**
     * 입력된 문자열을 ,(콤마)에 대해서 분리 후 List<String>으로 반환<br>
     * <br>
     *
     * @param lst 문자열
    ...
    /**
     * 입력된 문자열을 주어진 separator에 대해서 분리 후 List<String>으로 반환<br>
     * <br>
     *
    ...
    /**
     * 대소문자를 구분없이 기준 문자열에서 찾고자 하는 문자열이 포함되어 있는 경우 그 첫번째 문자열의 인덱스를 반환한다.<br>
     * <br>
     *
    ...
    /**
     * 입력된 문자열이 유니코드 문자로만 구성되었는지 체크<br>
     * <br>
     *
     ...
     *
     * <code>null</code> will return <code>false</code> An empty String (length()=0) will return <code>true</code>.<br />
     *
     * <pre>
     ...
     *
     * @param str 문자열
     * @return null 일경우 true 공백문자 일경우 true 이외의 경우 false
     */
     ...
     * 주어진 String이 null일 경우, false를 return한다.<br>
     * <br>
     *
     ...
     * @return true if String contains only digits, false if not or null string input
     */
    ...
    /**
     * 주어진 문자열이 null 또는 공백일 경우 참 반환<br>
     * <br>
     *
    ...
    // -----------------------------------------------------------------------
    /**
     * trim한 문자열이 null 또는 공백일 경우 참 반환<br>
     * <br>
     *
     ...
     *
     * @param str the String to check, may be null
     * @param pattern the pattern to check, may be null
     * @return true if String contains the given pattern, false if not or null string input
     */
    ...
    /**
     * 주어진 character가 한글인지의 여부를 판별한다.<br>
     * <br>
     *
     ...
     * full을 false로 설정할 경우, 한글이 하나라도 포함되어 있는지를 판별한다.<br>
     * <br>
     *
     ...
     *
     * @param str the String to check, may be null
     * @param checkForAll flag for check only Korean characters(true) or any Korean characters(false)
     * @return true if the String contains only Korean Language(when checkForAll is true) or any Korean characters(when
     *         checkForAll is false), false if not
     */
     ...
     *
     * @param str the String to check, may be null
     * @return true if String contains only letters, false if not or null string input
     */
     ...
     *
     * @param str the String to check, may be null
     * @return true if String contains only letters or digits, false if not or null string input
     */
     ...
     *
     * @param str 문자열
     * @return null이 아닐경우 true 공백문자가 아닐경우 true 이외의 경우 false
     */
    ...
    // -----------------------------------------------------------------------
    /**
     * 주어진 문자열이 null 또는 공백이 아닐 경우 참 반환<br>
     * <br>
     *
     ...
     *
     * @param str the String to check, may be null
     * @return true if String contains any letters, false if not or null string input
     */
     ...
     * 주어진 String이 null이면, false를 return한다.<br>
     * <br>
     *
     ...
     *
     * @param str the String to check, may be null
     * @return true if String contains only whitespace, false if not or null string input
     */
     ...
     * "..."을 붙이지 않는 점을 제외하고는 splitHead()와 동일하다.<br>
     * <br>
     *
    ...
    /**
     * 해당하는 문자열에 대해서 입력된 길이만큼 부족한 길이를 왼쪽부터 공백으로 채워넣는다.<br>
     * <br>
     *
    ...
    // -----------------------------------------------------------------------
    /**
     * 해당하는 문자열에 대해서 입력된 길이만큼 부족한 길이를 왼쪽부터 지정된 문자열로 채워넣는다.<br>
     * <br>
     *
    ...
    /**
     * CRLF(newLine)가 포함된 문자열을 입력인자로 받아 CRLF(개행문자)를 SPACE로 변환하여 리턴한다.<br>
     * <br>
     *
    ...
    public static String normalizeSpace(String str) {
        return org.apache.commons.lang.StringUtils.normalizeSpace(str);
    }

    // Mid
    // -----------------------------------------------------------------------
    /**
     * 주어진 String 객체를 검사하여 null일 경우 "" 을 반환하고, 아니면 원본을 반환한다.<br>
     * <br>
     *
    ...
    /**
     * 주어진 Object가 null이 아닐 경우 그 Object를 반환하고, null일 경우 default Object를 반환한다.<br>
     * <br>
     *
     ...
     * @return Returns the default Object if the given Object is null, returns the given Object if not
     */
    ...
    /**
     * 주어진 String이 null이 아닐 경우 그 String을 반환하고, null일 경우 default String을 반환한다.<br>
     * <br>
     *
     * StringUtils.nvl(null, "NULL TEST") = "NULL TEST"<br>
     * StringUtils.nvl("test", "NULL TEST")) = "test"
     ...
     * @return Returns the default String if the given String is null, returns the given String if not
     */
     ...
     * length는 String.getBytes().length 기준이 아닌 String.length() 기준임을 유의한다.<br>
     * <br>
     *
    ...
    /**
     * 입력된 문자열에 대해서 제거할 문자열을 모두 제거<br>
     * <br>
     *
    ...
    /**
     * 한 String 객체 안에서 주어진 문자(char)를 제거한다.<br>
     * <br>
     *
    ...
    /**
     * 한 String 객체 안에서 주어진 문자들을 제거한다.<br>
     * <br>
     *
     * StringUtils.removeCharAll("AbbzzB", new char[]{'b','z'}) = "AB"
     *
     * @param str the source String to search
     * @param remove chars to search for (case insensitive) and remove
    ...
    /**
     * unescaped된 문자열에 대해 HTML tag 형태로 바꿔준다.<br>
     * <br>
     *
    ...
    /**
     * 입력된 문자열에 대해서 해당하는 character를 찾아 주어진 문자열로 변경<br>
     * <br>
     *
    ...
    /**
     * 입력된 문자열이 주어진 문자열과 일치하는 모든 문자열을 바꿔야할 문자열로 변경<br>
     * <br>
     *
     * StringUtils.replaceAll("Anyframe Java Test Anyframe Java Test", "Anyframe", "Enterprise") =
     * "Enterprise Java Test Enterprise Java Test"
     *
     * @param source 문자열
     * @param regex 검색할 문자열
    ...
    /**
     * 입력된 문자열이 주어진 문자열과 일치하는 첫번째 문자열을 바꿔야할 문자열로 변경<br>
     * <br>
     *
     * StringUtils.replaceFirst("Anyframe Java Test Anyframe Java Test", "Anyframe", "Enterprise") =
     * "Enterprise Java Test Anyframe Java Test"
     *
     * @param source 문자열
     * @param regex 검색할 문자열
     * @param replacement 변경할 문자열
    ...
    // -----------------------------------------------------------------------
    /**
     * HTML tag가 들어있는 문자열에 대해 unescape해준다.<br>
     * <br>
     *
    ...
    /**
     * 입력된 문자열이 주어진 문자열과 일치하는 마지막 문자열을 바꿔야할 문자열로 변경<br>
     * <br>
     *
     * StringUtils.replaceLast("Anyframe Java Test Anyframe Java Test", "Anyframe", "Enterprise") =
     * "Anyframe Java Test Enterprise Java Test"
     *
     * @param source 문자열
     * @param regex 검색할 문자열
     * @param replacement 변경할 문자열
     ...
     * 따라서, 변환된 후에도 old 패턴은 남아 있을 수 있다.<br>
     * <br>
     *
     ...
     * 주어진 길이보다 주어진 String의 길이가 작을 경우에는 주어진 String을 그대로 반환한다.<br>
     * "..."을 붙이지 않는 점을 제외하고는 splitTail()와 동일하다.<br>
     * <br>
     *
    ...
    /**
     * 해당하는 문자열에 대해서 입력된 길이만큼 부족한 길이를 오른쪽부터 지정된 문자열로 채워넣는다.<br>
     * <br>
     *
     ...
     * @param string 문자열
     * @param searchStrings 검색문자배열
     * @return 문자열이 배열안의 검색문자로 시작되는경우와 문자열 양쪽모두 <code>null</code>인경우 <code>true</code>
     */
    public static boolean startsWithAny(String string, String[] searchStrings) {
        return org.apache.commons.lang.StringUtils.startsWithAny(string, searchStrings);
    }
     ...
     * @param str 문자열
     * @param prefix 검색문자
     * @return 문자열이 검색문자로 대소문자 구분없이 시작되는경우와 문자열 양쪽모두 <code>null</code>인경우 <code>true</code>
     */
    ...
    /**
     * 문자열의 내용 중 정해진 위치의 일부 문자열을 BigDecimal로 변환하여 리턴한다.<br>
     * <br>
     *
    ...
    /**
     * 문자열을 받아 해당하는 hex 코드로 만들어 반환한다. (유니코드)<br>
     * <br>
     *
    ...
    /**
     * 문자열의 내용 중 정해진 위치의 일부 문자열을 정수형으로 변환하여 리턴한다.<br>
     * <br>
     *
     ...
     *
     * <p>
     * 문자열이 <code>null</code>일경우 <code>null</code>을 반환. 문자열이 공백일경우 공백을 반환.
     * </p>
     *
     * <pre>
    ...
    /**
     * 입력된 문자열로 부터 숫자만 추출하여 '-'가 포함된 전화번호 형태의 문자열로 포매팅하여 리턴한다.<br>
     * <br>
     *
    ...
    public static String toTelephoneNumberFormat(String str) {
        ...
        if (UtCoStringUtils.isEmpty(str)) {
            return null;
        }
        ...
        if (UtCoStringUtils.isNotNumeric(origin)) {
     ...
     * 주어진 String이 숫자만으로 구성되어 있지 않을 경우 ""을 return한다.<br>
     * <br>
     *
    ...
    /**
     * 입력된 문자열에서 주어진 문자열과 일치하는 부분을 trim한다.<br>
     * <br>
     *
    ...
    /**
     * HTML 태그를 Escape로 변환한다.<br />
     *
     * @param str 문자
     * @return 결과문자열, 입력문자열이 null일경우 <code></code>
     */
    public static String htmlEscape(String str) {
        if (str == null) {
            ...
            return str.replaceAll("&", "&amp;").replaceAll("<", "&lt;").replaceAll(">", "&gt;")
                    .replaceAll("\"", "&quot;").replaceAll("'", "&apos");
        }
    }

    /**
     * Escape를 HTML 태그로 변환한다.<br />
     *
     * @param str 문자
     * @return 결과문자열, 입력문자열이 null일경우 <code></code>
     */
