...
<!-- CONTENT START -->
<form:form commandName="voBoard" id="noticeForm" name="noticeForm" method="post" onsubmit="return onetimeSubmit(this)">
<input type="hidden" id="pageIndex" name="pageIndex" value="${voBoard.pageIndex}"/>
 ...
 <tr>
  <td class="align_l" colspan="4" style="min-height:100px;">${voBoard.contents}</td>
 </tr>
 <tr>
  <th>첨부파일</th>
