...
<div id="selectUser_area" style="display:none;" >
  ...
  <!-- search start-->
    <div style="margin-bottom: 20px;">
     <table class="tbws0">
       <tr>
         <th colspan="2" ><input type="hidden" id="popupSearchStatus" name ="" ><input type="radio" id="searchStatus1" name ="searchStatus" value="0" checked> 사용자그룹ID <input type="radio" style="margin-left:10px" id="searchStatus1" name ="searchStatus" value="1"> 사용자그룹명 </th>
     <td class="align_l"><input type="text" class="middle4" id="popupSearchGrpId" name="searchGrpId" /></td>
         <!-- <th style="width:100px;"><input>사용자그룹ID</th>
         <td>
...
<script type="text/javaScript" defer="defer">
  ...
  var popupSearchStatus = $("input:radio[name=searchStatus]:checked").val();
    var popupSearchGrpId = $("#popupSearchGrpId").val();
    var popupSearchGrpNm = $("#popupSearchGrpNm").val();
    var entity = {
      pageNo:pageNo,
      groupNo:groupNo,
      searchStatus:popupSearchStatus,
    ...
    dwrUserGrpIdManagement.getSearchUserGroupListForDwr(entity, function resultReserveInfo(result) {
      ...
      for(var i=0 ; i < result.length ; i++){
        userObj = result[i];
          $("#userList").append("<tr class=\"tr_all\"><td>"+ userObj.userGrpId +"</td><td><a style=\"cursor:pointer\" onclick=\"selectGrp('"+ userObj.userGrpNo +"','" + userObj.grpNm +"','" + userObj.apprYn +"')\"><b>"+ userObj.grpNm +"</b></a></td><td>"+ userObj.grpExp +"</td></tr>");
      }
